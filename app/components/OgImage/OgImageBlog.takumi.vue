...
<template>
  <div class="bg-gray-900 w-full h-full flex flex-col">
    ...
    <div
      class="mx-26 mt-24 border-y-2 border-gray-700 h-14 flex flex-row items-center"
    >
      <div
        class="h-full uppercase flex items-center text-[#EAB308] text-[20px] font-semibold px-6 pt-1"
      >
        Litestar Blog
      </div>
    </div>
    <div class="mx-34 h-[290px] flex flex-col justify-center">
