...
<template>
  <p class="text-center text-lg sm:text-xl/8 text-muted">
    Litestar welcomes contributors from all backgrounds and skill levels. Join our growing community to help by answering questions, improving documentation, joining discussions, or contributing to development.
  </p>
  <div
    v-intersection-observer="onIntersectionObserver"
    class="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-10 gap-4 sm:gap-8 lg:gap-6 xl:gap-8 xl:p-8"
